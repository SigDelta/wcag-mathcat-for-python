...
class MathCATPreferencesDialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.m_staticTextGenerateSpeechFor1 = wx.StaticText(
            self.m_panelSpeech,
            wx.ID_ANY,
        ...
        m_choiceLanguageChoices = [_("xxxxxxxxxxxxxxxx")]
        ...
        self.m_staticText21111 = wx.StaticText(
            self.m_panelSpeech,
            wx.ID_ANY,
        ...
        self.m_staticText411 = wx.StaticText(
            self.m_panelSpeech,
            wx.ID_ANY,
        ...
        self.m_staticText511 = wx.StaticText(
            self.m_panelSpeech,
            wx.ID_ANY,
        ...
        self.m_simplebookPanelsCategories.AddPage(
            self.m_panelSpeech, _("a page"), False
        )
        ...
        self.m_simplebookPanelsCategories.AddPage(
            self.m_panelNavigation, _("a page"), False
        )
        ...
        self.m_staticTextGenerateSpeechFor112 = wx.StaticText(
            self.m_panelBraille,
            wx.ID_ANY,
        ...
        m_choiceBrailleMathCodeChoices = [_("Nemeth"), _("UEB")]
        ...
        self.m_simplebookPanelsCategories.AddPage(
            self.m_panelBraille, _("a page"), False
        )
